  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse show" id="navbarColor03">
      ...
      <?php if($_SESSION['login']):?>
        <li class="nav-item">
          <a href="?m=tempat" class="nav-link active"><span></span> Tempat</a>
        </li>
        <li class="nav-item">
          <a href="?m=galeri" class="nav-link active"><span></span> Galeri</a>
        </li>
          <li class="nav-item">
        <a href="?m=password" class="nav-link active"><span></span> Password</a>
        </li>
        <li class="nav-item">
          <a href="aksi.php?act=logout" class="nav-link active"><span></span> Logout</a>
        </li>
        <?php else:?>   
        <li class="nav-item">
          <a href="?m=tempat_list" class="nav-link active"><span></span> Tempat</a>
        </li>
        <li class="nav-item">
          <a href="?m=login" class="nav-link active"><span></span> Login</a>
        </li>
        <?php endif?>    
      </ul>
    </div>
